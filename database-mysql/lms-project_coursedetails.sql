...
CREATE TABLE `coursedetails` (
  `idcrs` varchar(45) NOT NULL,
  `namecrs` varchar(45) DEFAULT NULL,
  `unit1` varchar(300) DEFAULT NULL,
  `unit2` varchar(300) DEFAULT NULL
...
INSERT INTO `coursedetails` VALUES ('cs301',NULL,'databases and all the terminologies are explaied in detail','We learn join functions in detail');
